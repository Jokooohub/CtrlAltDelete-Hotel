...
<body class="bg-light">
                ...
                echo<<<bookings
                    <div class='col-md-4 px-4 mb-4'>
                        <div class='bg-white p-3 rounded shadow-sm'>
                            ...
                            <p> <b> Room no: <span class='badge custom-bg'>$data[room_no]</span> </b> </p>
                            $btn
                        </div>
                    </div>
                bookings;
                ...
                <form id="review-form">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea type="review" name="review" rows="3" required class="form-control shadow-none"></textarea>
                        </div>
    ...
    <?php 
        if(isset($_GET['cancel_status'])){
            ...
            alert('success','Thank you for the review!');
        }
    ?>
