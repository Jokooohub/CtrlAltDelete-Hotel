...
<h6 class="text-center bg-dark text-white p-3 m-0"><?php echo $settings_r['site_title'] ?></h6>
...
<script>
    ...
    function checkLoginToBook(status,room_id){
        ...
        console.log('checkLoginToBook called with status:', status, 'and room_id:', room_id);
